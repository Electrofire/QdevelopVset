...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Tue Apr 26 02:38:29 2011
# Project:  vset.pro
# Template: app
...
SOURCES       = src/animatorwindow.cpp \
		...
		src/Workspace.cpp \
		src/modelwindow.cpp build/moc_animatorwindow.cpp \
